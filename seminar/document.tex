...
\end{wrapfigure}
  ...
  In contrast to the shielding tensor, which depends only on electron density,
...
options is to use large cut-out of crystal structure and non-periodic boundary conditions. In the latter case one needs to add atoms at the
