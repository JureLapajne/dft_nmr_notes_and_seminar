...
\cite{Assignment_of_Solid_State}. Many chemical properties stem from unpaired
...
the motion of electrons, sometimes nuclei are even fixed. Thus, from now on we will
