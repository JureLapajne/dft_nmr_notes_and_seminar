...
\usetheme[sectionpage=none, subsectionpage=none, numbering=none, progressbar=foot]{metropolis} % izbira nastavitev oblike in barv strani
...
\setbeamercolor{background canvas}{
 use=palette primary,
 bg=White}
\setbeamercolor{title seaprator}{
 use=palette primary,
 bg=Blue}
