...
Calculation of electronic structure of different substances has always been a challenge. It quickly became apparent that direct use of schroedinger equation is not a realistic prospect for calculation of electronic structure, except for some small molecules. It's time complexity grows exponentially as a function of electron number. With the development of computers different numerical shemes for computation of electronic structure and optimization of mlecular structure have emerged. One of them is also density functional theory, which has been known for roughly 50 years.	
