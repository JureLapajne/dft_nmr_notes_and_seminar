...
while still being sufficiently accurate, offer faster computational times. In
this paper we will discus dft and it's applications to organo-metalic materials.
...
densities $n(\vec r)$. Since the Hamiltonian \ref{ks_hamiltonian} is defined for
all
\end{document}